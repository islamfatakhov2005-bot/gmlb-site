/*
  GMLB Automation — Contact / Lead Form Section
  Design: Two-column layout, dark form with blue focus states
*/
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 btn-outline-blue"
            >
              <Send size={16} />
              Написать в Telegram
            </a>
