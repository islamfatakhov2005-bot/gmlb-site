      ...
      <div className="container mx-auto">
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6 }}>
            ...
            <p className="text-base leading-relaxed mb-8" style={{ color: 'rgba(230,237,243,0.6)' }}>{description}</p>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.2 }} className="relative">
            <div
              ...
              style={{ border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 0 60px rgba(34,197,94,0.12), 0 20px 60px rgba(0,0,0,0.5)' }}
            >
              {imageUrl ? (
                ...
                <div className="w-full h-64 flex items-center justify-center" style={{ background: 'rgba(34,197,94,0.05)' }}>
                  <div className="text-center">
                    ...
                    <div className="text-sm" style={{ color: 'rgba(230,237,243,0.4)' }}>Автоматизация бизнеса</div>
                  </div>
                </div>
              )}
            </div>
            <div
              ...
              style={{ background: 'rgba(13,17,23,0.9)', border: '1px solid rgba(34,197,94,0.25)', backdropFilter: 'blur(10px)', boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}
            >
              <div className="text-xl font-bold" style={{ color: '#22C55E' }}>{statValue}</div>
              <div className="text-xs" style={{ color: 'rgba(230,237,243,0.5)' }}>{statLabel}</div>
            </div>
          </motion.div>
        </div>
      </div>
